...
interface SidenavProps extends WithResizeProps {
  onCloseDrawer: () => void;
}
...
const _Sidenav = ({ onCloseDrawer, windowSize }: SidenavProps) => (
  <aside
    id="amdbSidenav"
  ...
  >
    <div className="mx-auto w-full max-w-6xl py-8 px-4">
      ...
      <div className="flex items-center">
        ...
        <Button className="ml-auto" variant="secondary" onPress={onCloseDrawer}>
